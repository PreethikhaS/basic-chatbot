function getResponse() {
  ...
  if (userText.includes("hours")) {
    ...
    botMsg.innerHTML =
      "We accept credit cards, PayPal, and major payment gateways like Stripe.";
  } else if (userText.includes("track")) {
    botMsg.innerHTML =
      "You can track your order through the shipping confirmation email we sent.";
    ...
    botMsg.innerHTML =
      "We offer standard and express shipping. it takes 1-3 business days.";
